...
public class UserServiceTest {
    ...
    public void test_throw_InvalidUserException() {
        throw new InvalidUserException("Testing InvalidUserException...");
    }

    @Ignore // (expected = InvalidUserException.class)
    public void test_invalidUsernamethrows_InvalidUserException() {
        ...
        //Act
        try {
            createdUser = spySut.signup(stubbedReq);
