...
import static com.revature.erts.models.ReimbursementStatus.*;
...
public class DatatypeCrossRef {
    ...
    public static ReimbursementStatus statusText2Enum(String statusText) {
    ...
    public static String statusEnum2Text(ReimbursementStatus status) {
        String statusText;
    ...
    public static String statusEnum2UUID(ReimbursementStatus status) {
        String statusUUID;
    ...
    public static ReimbursementStatus statusUUID2Enum(String statusUUID) {
        ReimbursementStatus status;
    ...
    public static UserRole roleText2Enum(String roleText) {
        UserRole userRole;
    ...
    public static String roleEnum2Text(UserRole role) {
        String roleText;
    ...
    public static String roleText2UUID(String roleText) {
        String roleUUID;
    ...
    public static String roleEnum2UUID(UserRole role) {
        String roleUUID;
    ...
    public static UserRole roleUUID2Enum(String roleUUID) {
        UserRole userRole;
    ...
    public static String roleUUID2Text(String roleUUID) {
        String roleText;
